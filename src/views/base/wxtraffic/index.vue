<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-select clearable class="filter-item" style="width: 200px" v-model="listQuery.query_data.type"
                 :placeholder="$t('table.common.type')">
        <el-option v-for="item in  ['景区内', '景区外']" :key="item" :label="item" :value="item">
        </el-option>
      </el-select>
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" :element-loading-text="$t('table.loading')" border
    ...
    <div class="pagination-container">
      <el-pagination background @size-change="handleSizeChange" @current-change="handleCurrentChange"
                     :current-page="listQuery.query_data.current_page" :page-sizes="[10,20,30, 50]"
                     :page-size="listQuery.query_data.page_size" layout="total, sizes, prev, pager, next, jumper"
                     :total="total">
      </el-pagination>
    </div>
              ...
              <el-col :span="12">
                <el-form-item :label="$t('table.common.type')" prop="type">
                  <el-select v-model="temp.type">
                    <el-option v-for="item in  ['景区内', '景区外']" :key="item" :label="item" :value="item"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :span="12">
