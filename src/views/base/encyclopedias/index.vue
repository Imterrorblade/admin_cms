<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" :placeholder="$t('table.common.name')" v-model="listQuery.query_data.name">
      </el-input>
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" :element-loading-text="$t('table.loading')" border fit highlight-current-row
              style="width: 100%">
      <el-table-column min-width="150px" align="center" :label="$t('table.common.name')">
        <template slot-scope="scope">
          <span>{{scope.row.name}}</span>
        </template>
      </el-table-column>
      <el-table-column min-width="150px" align="center" :label="$t('table.common.description')">
        <template slot-scope="scope">
          <span>{{scope.row.description}}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" :label="$t('table.common.type')">
        <template slot-scope="scope">
      ...
      <el-form :rules="rules" ref="dataForm" :model="temp" label-position="right" label-width="110px">
        <el-card class="box-card">
          ...
          <div>
            <el-row :gutter="20">
              <el-col :span="8">
                <el-form-item :label="$t('table.common.name')" prop="name">
            ...
            <el-row :gutter="20">
              <el-col :span="24">
                <el-form-item :label="$t('table.common.description')" prop="description">
                  <el-input type="textarea" v-model="temp.description" size="small"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </div>
        ...
        <el-card class="box-card">
          ...
          <div>
            <el-form-item :label="$t('table.common.logo_image')" prop="logo_image">
  ...
  export default {
    ...
    data() {
      return {
        ...
        listLoading: true,
        listQuery: {
          'resource_name': 'encyclopedias_info',
          'query_data': {
            'name': '',
            'level': '',
            'current_page': 1,
        ...
        scenicTypeOptions,
        typeOpts: ['历史文化', '湿地民风', '湿地动物', '湿地植物', '环境指数'],
        examineOpts: [{
          label: '未审核',
          value: 'check_N'
        }, {
        ...
        pvData: [],
        rules: this.getRules(['name', 'type', 'to_examine', 'logo_image']),
