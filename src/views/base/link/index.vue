<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" :element-loading-text="$t('table.loading')" border fit highlight-current-row
      ...
      <el-table-column min-width="150px" align="center" :label="$t('table.common.intro')">
        <template slot-scope="scope">
              ...
              <el-col :span="12">
                <el-form-item :label="$t('table.common.type')" prop="type">
                  <el-select v-model="temp.type">
                    <el-option v-for="item in ['电话', '网址', '其他']" :key="item" :label="item" :value="item"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :span="24">
                <el-form-item :label="$t('table.common.intro')" prop="intro">
                  <el-input type="textarea" v-model="temp.intro" size="small"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </div>
