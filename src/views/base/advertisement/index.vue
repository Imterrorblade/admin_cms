<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" :placeholder="$t('table.advertisement.name')" v-model="listQuery.query_data.name">
      </el-input>
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" :element-loading-text="$t('table.loading')" border fit highlight-current-row
              style="width: 100%">
      <el-table-column min-width="150px" align="center" :label="$t('table.advertisement.name')">
      ...
      <el-form :rules="rules" ref="dataForm" :model="temp" label-position="right" label-width="110px">
        <el-card class="box-card">
          <div slot="header" class="clearfix">
            <span>{{$t('table.common.modules')}}</span>
          </div>
          <div>
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item :label="$t('table.advertisement.name')" prop="name">
                  <el-input v-model="temp.name" size="small"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item :label="$t('table.common.link_address')" prop="link_address">
                  <el-input v-model="temp.link" size="small"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </div>
        ...
        <el-card class="box-card">
          ...
          <div>
            <el-form-item :label="$t('table.advertisement.logo_image')">
  ...
  export default {
    ...
    data() {
      return {
        ...
        listLoading: true,
        listQuery: {
          'resource_name': 'advertisement_info',
          'query_data': {
            'name': '',
            'level': '',
            'current_page': 1,
