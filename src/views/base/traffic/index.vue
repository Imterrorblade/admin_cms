<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-select clearable class="filter-item" style="width: 200px" v-model="listQuery.query_data.name" :placeholder="$t('table.common.name')">
        <el-option v-for="item in  ['自驾游', '自助游']" :key="item" :label="item" :value="item">
        </el-option>
      </el-select>
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" :element-loading-text="$t('table.loading')" border fit highlight-current-row
              style="width: 100%">
      <el-table-column min-width="150px" align="center" :label="$t('table.traffic.name')">
        <template slot-scope="scope">
          <span>{{scope.row.name}}</span>
        </template>
      </el-table-column>
      <el-table-column min-width="150px" align="center" :label="$t('table.common.to_examine')">
        <template slot-scope="scope">
          <span>{{scope.row.to_examine | examineFilter}}</span>
        </template>
      </el-table-column>
      ...
      <el-form :rules="rules" ref="dataForm" :model="temp" label-position="right" label-width="110px">
        <el-card class="box-card">
          ...
          <div>
            <el-row :gutter="20">
              <el-col :span="8">
                <el-form-item :label="$t('table.traffic.name')" prop="name">
                  <el-select v-model="temp.name">
                    <el-option v-for="item in  ['自驾游', '自助游']" :key="item" :label="item" :value="item">
                    </el-option>
                  </el-select>
                </el-form-item>
              ...
              <el-col :span="8">
                <el-form-item :label="$t('table.common.to_examine')" prop="common">
                  <el-select  disabled="" class="filter-item" v-model="temp.to_examine" placeholder="Please select">
        ...
        <el-card class="box-card">
          ...
          <div>
            <el-form-item :label="$t('table.common.intro')">
