<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" :placeholder="$t('table.video.name')" v-model="listQuery.query_data.name">
      </el-input>
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" :element-loading-text="$t('table.loading')" border fit highlight-current-row
              style="width: 100%">
      <el-table-column min-width="150px" align="center" :label="$t('table.video.name')">
        <template slot-scope="scope">
          <span>{{scope.row.name}}</span>
        </template>
      </el-table-column>
      <el-table-column min-width="150px" align="center" :label="$t('table.video.description')">
        <template slot-scope="scope">
      ...
      <el-form :rules="rules" ref="dataForm" :model="temp" label-position="right" label-width="110px">
        <el-card class="box-card">
          ...
          <div>
            <el-row :gutter="20">
              <el-col :span="8">
                <el-form-item :label="$t('table.video.name')" prop="name">
                  <el-input v-model="temp.name" size="small"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item :label="$t('table.video.to_examine')" prop="to_examine">
              ...
              <el-col :span="8">
                <el-form-item :label="$t('table.video.channel')" prop="channel">
            ...
            <el-row :gutter="20">
              <el-col :span="24">
                <el-form-item :label="$t('table.video.description')" prop="description">
                  <el-input height="60" type="textarea" v-model="temp.description" size="small"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </div>
        ...
        <el-card class="box-card">
          ...
          <div>
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item :label="$t('table.video.logo_image')">
                  <Upload v-model="temp.logo_image"></Upload>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item :label="$t('table.video.video')">
        ...
        <el-card class="box-card">
          ...
          <div>
            <el-form-item :label="$t('table.video.intro')">
  ...
  export default {
    ...
    data() {
      return {
        ...
        pvData: [],
        rules: this.getRules(['name', 'to_examine']),
