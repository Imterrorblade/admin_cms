  ...
  <div class="upload-container">
    <div class="image-preview image-app-preview" v-show="imageUrl">
      <div class="image-preview-wrapper" >
        <img :src="imageUrl">
        <div v-if="!params.onlyshow" class="image-preview-action">
          <i @click="rmImage" class="el-icon-delete"></i>
        </div>
      </div>
    </div>
    <el-upload v-if="!params.onlyshow" class="image-preview image-app-preview" :data="dataObj" drag :multiple="false" :show-file-list="false" v-show="!imageUrl"
      action="_api_/cms/material/uploadMaterial" :accept="this.acceptTypes.map(item => {
        return `image/${item}`
      }).toString()"
      :on-success="handleImageScucess" :on-progress="handleProgress" :before-upload="beforeUpload" :on-error="handleError" >
